...
let RequirementService = class RequirementService extends crud_typeorm_1.TypeOrmCrudService {
    constructor(repo) {
        super(repo);
    }
};
RequirementService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(Requirement_1.Requirement)),
